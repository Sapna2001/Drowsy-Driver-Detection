...
# Login page
drowsy_img = ImageTk.PhotoImage(Image.open("icon.png"))
        ...
        if len(str_emergency) < 10 or len(str_emergency) > 10:
            ...
            def web_detect():
                ...
                def calculate_MAR(a,b,c,d,e,f,g,h):
                    v_lip = dist.euclidean(c, d) + dist.euclidean(e, f) + dist.euclidean(g, h)   #vertical mouth distances
                    h_lip = dist.euclidean(a, b)   #horizontal mouth distances
                ...
                while True:
                    ...
                    for face in faces:
                        ...
                        if(left_blink == 0 or right_blink == 0):
                            ...
                            drowsy = 0
                            if(sleep > 6):
                                mixer.music.load("mixkit-vintage-warning-alarm-990.wav")
                            ...
                            active = 0
                            if(drowsy > 3):
                                mixer.music.load("audio_drowsy.mp3")
                                mixer.music.set_volume(0.8)
                                mixer.music.play()
